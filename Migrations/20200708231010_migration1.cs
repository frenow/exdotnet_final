...
namespace ProjetoDotNet2.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Texto = table.Column<string>(maxLength: 2000, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Depoimento", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Depoimento_Cliente_ClienteId",
